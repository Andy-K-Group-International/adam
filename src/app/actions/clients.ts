...
function wrap(body: string) {
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#f0f4f4;font-family:'Helvetica Neue',Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4f4;padding:40px 20px;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;"><tr><td style="background:#f0f4f4;padding:20px 40px;border-radius:12px 12px 0 0;border:1px solid #ede8e2;border-bottom:none;"><table cellpadding="0" cellspacing="0"><tr><td width="36" style="vertical-align:middle;">${LOGO}</td><td style="padding-left:10px;vertical-align:middle;"><span style="font-family:Georgia,serif;color:#0E282D;font-size:15px;font-weight:700;">A.D.A.M.</span></td></tr></table></td></tr><tr><td style="background:#fff;padding:40px;border-left:1px solid #ede8e2;border-right:1px solid #ede8e2;">${body}</td></tr><tr><td style="background:#f0f4f4;padding:14px 32px;border-radius:0 0 12px 12px;border:1px solid #ede8e2;border-top:none;text-align:center;"><p style="font-family:'Courier New',monospace;font-size:10px;color:#8b93a8;margin:0;">Andy&#8217;K Group International LTD &middot; 86-90 Paul Street, London EC2A 4NE</p></td></tr></table></td></tr></table></body></html>`;
}

function buildReactivationHtml(name: string, company: string) {
  return wrap(`<h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#0E282D;margin:0 0 20px;">We&#8217;d love to continue working together</h1><p style="color:#525a70;font-size:15px;line-height:1.7;margin:0 0 16px;">Hi ${name},</p><p style="color:#525a70;font-size:15px;line-height:1.7;margin:0 0 28px;">We&#8217;ve prepared a new proposal for ${company} and would love to continue building on our work together. Log in to your portal to review it.</p><a href="https://adam.andykgroup.com/dashboard" style="display:inline-block;background:#2F9E9A;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-size:14px;font-weight:600;margin-bottom:32px;">View Portal &#8594;</a><p style="color:#525a70;font-size:13px;line-height:1.6;margin:0;">Warm regards,<br><strong>The Andy&#8217;K Group International LTD Team</strong></p>`);
}

function buildReportEmailHtml(name: string, company: string, title: string, period: string) {
  return wrap(`<h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#0E282D;margin:0 0 20px;">Your ${period} Report is Ready</h1><p style="color:#525a70;font-size:15px;line-height:1.7;margin:0 0 16px;">Hi ${name},</p><p style="color:#525a70;font-size:15px;line-height:1.7;margin:0 0 24px;">Your ${period.toLowerCase()} report for ${company} has been published.</p><div style="background:#f0f4f4;border-left:2px solid #2F9E9A;padding:16px 20px;border-radius:0 8px 8px 0;margin-bottom:28px;"><p style="color:#8b93a8;font-family:'Courier New',monospace;font-size:10px;text-transform:uppercase;letter-spacing:0.12em;margin:0 0 4px;">Report</p><p style="color:#0E282D;font-size:15px;font-weight:600;margin:0;">${title}</p></div><a href="https://adam.andykgroup.com/dashboard/reports" style="display:inline-block;background:#2F9E9A;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-size:14px;font-weight:600;margin-bottom:32px;">Read Report &#8594;</a><p style="color:#525a70;font-size:13px;line-height:1.6;margin:0;">Warm regards,<br><strong>The Andy&#8217;K Group International LTD Team</strong></p>`);
}

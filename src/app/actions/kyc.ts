...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#faf6f3;padding:40px 20px;">
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      <tr><td style="background:#faf6f3;padding:20px 40px;border-radius:12px 12px 0 0;border:1px solid #ede8e2;border-bottom:none;">
        <table cellpadding="0" cellspacing="0"><tr>
          ...
          <td style="padding-left:12px;vertical-align:middle;">
            <span style="font-family:Georgia,'Times New Roman',serif;color:#01011b;font-size:16px;font-weight:700;">A.D.A.M.</span>
      ...
      <tr><td style="background:#faf6f3;padding:16px 32px;border-radius:0 0 12px 12px;border:1px solid #ede8e2;border-top:none;">
        <table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td style="vertical-align:middle;width:33%;"><table cellpadding="0" cellspacing="0"><tr>
            ...
            <td style="padding-left:7px;vertical-align:middle;"><span style="font-family:'Courier New',monospace;font-size:11px;font-weight:700;color:#01011b;">A.D.A.M.</span></td>
          </tr></table></td>
          ...
          <td style="text-align:right;vertical-align:middle;width:33%;">
            <a href="https://andykgroup.com" style="font-family:'Courier New',monospace;font-size:10px;color:#c9707d;text-decoration:none;">andykgroup.com</a>
          </td>
        </tr></table>
      </td></tr>
    </table>
  ...
  try {
    ...
    if (client) {
      const html = emailHtml("KYC Alert", `
        <h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#01011b;margin:0 0 20px;">KYC submitted for review</h1>
  ...
  try {
    ...
    if (client) {
      ...
      const html = emailHtml("KYC Verified", `
        <h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#01011b;margin:0 0 20px;">Your KYC has been verified</h1>
  ...
  try {
    ...
    if (client) {
      ...
      const html = emailHtml("KYC Update", `
        <h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#01011b;margin:0 0 20px;">Action required: KYC resubmission</h1>
        <p style="color:#525a70;font-size:15px;line-height:1.7;margin:0 0 16px;">Dear ${client.contact_name},</p>
        ...
        <div style="background:#fef2f2;border-left:2px solid #ef4444;padding:16px 20px;border-radius:0 8px 8px 0;margin-bottom:28px;">
          ...
          <p style="color:#01011b;font-size:14px;margin:0;">${reason}</p>
        </div>
        ...
        <div style="margin-bottom:28px;">
          <a href="https://adam.andykgroup.com/dashboard/profile" style="display:inline-block;background:#c9707d;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-size:14px;font-weight:600;">Resubmit KYC &#8594;</a>
        </div>
        <div style="border-top:1px solid #ede8e2;padding-top:20px;">
          <p style="color:#525a70;font-size:13px;line-height:1.6;margin:0;">Warm regards,<br><strong>The Andy&#8217;K Group International LTD Team</strong></p>
        </div>

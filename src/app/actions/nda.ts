      ...
      <tr><td style="background:#faf6f3;padding:16px 32px;border-radius:0 0 12px 12px;border:1px solid #ede8e2;border-top:none;">
        <table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td style="vertical-align:middle;width:33%;"><table cellpadding="0" cellspacing="0"><tr>
            ...
            <td style="padding-left:7px;vertical-align:middle;"><span style="font-family:'Courier New',Courier,monospace;font-size:11px;font-weight:700;color:#01011b;letter-spacing:0.04em;">A.D.A.M.</span></td>
          </tr></table></td>
          ...
          <td style="text-align:right;vertical-align:middle;width:33%;">
            <a href="https://andykgroup.com" style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#c9707d;text-decoration:none;">andykgroup.com</a>
          </td>
        </tr></table>
      </td></tr>
    </table>
    ...
    <div style="background:#faf6f3;border-left:2px solid #c9707d;padding:16px 20px;border-radius:0 8px 8px 0;margin-bottom:28px;">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="padding:5px 0;color:#01011b;font-size:13px;border-bottom:1px solid #ede8e2;">${name}</td>
        </tr>
        <tr>
          ...
          <td style="padding:5px 0;color:#01011b;font-size:13px;border-bottom:1px solid #ede8e2;">${company}</td>
        </tr>
        <tr>
          ...
          <td style="padding:5px 0;color:#01011b;font-size:13px;">${signedAt}</td>
        </tr>
      </table>
    </div>
...
async function sendNdaAdminNotification({
  ...
  const html = emailHtml("NDA Alert", `
    <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:22px;font-weight:700;color:#01011b;margin:0 0 20px;line-height:1.3;">New NDA signed</h1>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
      ...
      <tr>
        ...
        <td style="padding:7px 0;font-size:13px;border-bottom:1px solid #ede8e2;"><a href="mailto:${email}" style="color:#c9707d;text-decoration:none;">${email}</a></td>
      </tr>
      <tr>

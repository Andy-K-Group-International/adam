  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="background:#ffffff;padding:40px;border-left:1px solid #ede8e2;border-right:1px solid #ede8e2;">
        <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:24px;font-weight:700;color:#01011b;margin:0 0 16px;line-height:1.3;">Reset your password</h1>
        ...
        <div style="margin-bottom:32px;">
          <a href="${resetUrl}" style="display:inline-block;background:#c9707d;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-size:14px;font-weight:600;letter-spacing:0.01em;">Reset Password &#8594;</a>
        </div>
        <div style="background:#faf6f3;border-left:2px solid #ede8e2;padding:14px 18px;border-radius:0 8px 8px 0;margin-bottom:28px;">
          ...
          <p style="color:#01011b;font-size:12px;margin:0;font-family:'Courier New',monospace;word-break:break-all;">${resetUrl}</p>
        </div>

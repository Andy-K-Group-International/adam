...
export const pricingData = {
  ...
  tech: {
    ...
    plans: [
      {
        ...
        price: "€249",
        period: "/mo",
        description: "Basic features for a single user — everything you need to get started.",
        features: [
          "Single user access",
          "Client portal",
      ...
      },
      {
        ...
        price: "€450",
        period: "/mo",
        description: "Full features with team access — scale your operations with advanced automation.",
        features: [
      ...
      },
      {
        ...
        price: "Custom",
        period: "",
        description: "Custom deployment with priority support — tailored for large-scale operations.",
        features: [
    ...
    addon: {
      name: "Branding Add-on",
      price: "$750",
      description: "Custom branding package — logo, colors, and identity applied across your A.D.A.M. instance.",
    },
  },
};
